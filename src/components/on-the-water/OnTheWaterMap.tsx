...
type Props = {
  ...
  places: WaterMapPlace[];
  selectedId?: string | null;
  onSelect?: (id: string) => void;
  onPlanTrip?: (place: WaterMapPlace) => void;
  savedKeys?: string[];
  onToggleSaved?: (place: WaterMapPlace) => void;
};
...
function MapController({
  ...
  useEffect(() => {
    ...
    if (!showStartMarker && places.length === 0) {
...
export default function OnTheWaterMap({
  startLatitude,
  startLongitude,
  startLabel,
