...
async function getPlanAuthHeaders() {
...
console.log("NEARBY EVENT DATA:", data.events);
  ...
  recentForRequest: string[]
    ...
    try {
      ...
      setError("");
      setSaveMessage("");
const offRoadPremiumRequest =
  /OFF THE ROAD PREMIUM\s*[—-]\s*(TRAIL INTELLIGENCE|FULL ADVENTURE|BASECAMP WEEKEND|VERIFIED HUNTING EXPEDITION)/i.test(
    savedRequest
  );
